...
- `fast_loader_{pusht,cube,reacher,tworoom}_20260723.json`: paired,
  steady-state Source/FAST loader throughput after untimed priming. PushT is a
  ten-pair confirmation; the other task reports contain five measured pairs.
